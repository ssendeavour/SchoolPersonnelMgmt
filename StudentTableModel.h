...
inline void StudentTableModel::setEnableFilter(bool enable){
...
inline void StudentTableModel::setFilterColumn(const CONST::HDG column){
...
inline void StudentTableModel::setFilterSex(const Person::Sex sex){
...
inline void StudentTableModel::setFilterCaseSentivity(bool sensitive){
...
inline void StudentTableModel::setFilterMinDate(const QDate &min){
...
inline void StudentTableModel::setFilterMaxDate(const QDate &max){
